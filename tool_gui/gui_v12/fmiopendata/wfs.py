...
EF_ACTIVITY_TIME = ".//{http://inspire.ec.europa.eu/schemas/ef/4.0}activityTime"
EF_BELONGS_TO = ".//{http://inspire.ec.europa.eu/schemas/ef/4.0}belongsTo"
EF_ID = ".//{http://inspire.ec.europa.eu/schemas/ef/4.0}inspireId"
EF_MONITORING_FACILITY = ".//{http://inspire.ec.europa.eu/schemas/ef/4.0}EnvironmentalMonitoringFacility"
...
INS_ID = ".//{http://inspire.ec.europa.eu/schemas/base/3.3}Identifier"
INS_LOCALID = ".//{http://inspire.ec.europa.eu/schemas/base/3.3}localId"
...
def download_stored_query(query_id, args=None):
    ...
    elif "stations" in query_id.lower():
