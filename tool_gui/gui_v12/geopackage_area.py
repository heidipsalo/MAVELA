...
class GeopackageArea():
    def __init__(self, settings):
        ...
        fa_coords = self.calculate_area_coords((fa_x, fa_y), fa_length)
        ...
        nd_coords = self.calculate_area_coords((nd_x, nd_y), nd_length)
        ...
        si_coords = self.calculate_area_coords((si_x, si_y), si_length)
        ...
        sa_coords = self.calculate_area_coords((sa_x, sa_y), sa_length)
        ...
        cra_coords = self.calculate_area_coords((cra_x, cra_y), cra_length)
    ...
    def calculate_area_coords(self, point, size):
        coords = []
