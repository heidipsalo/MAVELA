...
class SoilParam():
    def __init__(self, settings):
        ...
        first_row = df.query("Layer.str.startswith('Top') & Type == @settings.top_soil_layer & Macros == @settings.top_soil_macros")
        second_row = df.query("Layer.str.startswith('Bot') & Type == @settings.bottom_soil_layer & Macros == @settings.bottom_soil_macros")
        #print(second_row)
        ...
        self.generate_geom_layers(settings.user_depth, settings.input_folder)
...
"""
    ...
    def generate_geom_layers(self, user_depth, input_folder):
